function createSun(containerId, modelPath) {
    ...
    renderer.domElement.addEventListener('dblclick', function(event) {
        ...
        if (intersects.length > 0) {
            window.location.href = '../sun/sun.html'; // Заменить на нужную ссылку
        }
        });
...
function createMercury(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '../mercury/mercury.html'; // Заменить на нужную ссылку
    }
    });
    // Анимация
    function animate() {
...
function createVenus(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/venus/venus.html'; // Заменить на нужную ссылку
    }
    });
    // Анимация
    function animate() {
...
function createEarth(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/earth/earth.html'; // Заменить на нужную ссылку
    }
    });
    // Анимация
    function animate() {
...
function createMars(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/mars/mars.html'; // Заменить на нужную ссылку
    }
    });
    // Анимация
    function animate() {
...
function createJupiter(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/jupiter/jupiter.html'; // Заменить на нужную ссылку
    }
    });
...
function createSaturn(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/saturn/saturn.html'; // Заменить на нужную ссылку
    }
    });
...
function createUran(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/uran/uran.html'; // Заменить на нужную ссылку
    }
    });
    // Анимация
    function animate() {
...
function createNeptune(containerId, modelPath) {
    ...
    if (intersects.length > 0) {
        window.location.href = '/neptun/neptun.html'; // Заменить на нужную ссылку
    }
    });
    // Анимация
    function animate() {
